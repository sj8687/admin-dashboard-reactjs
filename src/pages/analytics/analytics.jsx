...
export default function Analytics() {
    ...
    const { drivers, revenueChart, driversLoading, revenueLoading, } = useSelector((state) => state.posts);
    useEffect(() => {
    ...
    return (<div className="space-y-6 px-4 sm:px-6 lg:px-8 py-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="p-4 sm:p-6">
          ...
          {chartLoading ? (<div className="h-[220px] flex items-center justify-center text-slate-400">
              Loading chart...
            </div>) : (<ResponsiveContainer width="100%" height={220}>
      ...
      <Card className="overflow-hidden">
        ...
        {leaderboardLoading ? (<div className="py-16 text-center text-slate-400">
            Loading drivers...
          </div>) : (<>
            {/* Desktop Table */}
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-slate-700/50">
                    {["#", "Driver", "Trips", "Rating", "Earnings"].map((h) => (<th key={h} className="px-5 py-3 text-left text-xs font-semibold text-slate-500 uppercase">
                        {h}
                      </th>))}
                  </tr>
                </thead>
                ...
                .map((d, i) => (<tr key={d.id} className="border-b border-slate-700/30">
            ...
            <div className="md:hidden p-4 space-y-4">
              {[...drivers]
                .sort((a, b) => b.trips - a.trips)
                .map((d, i) => (<div key={d.id} className="bg-slate-800/50 rounded-xl p-4 space-y-2">
